<?php
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE apo_heading SET
            ...
            <div class="col-9 clm_dash">
                    ...
                    <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="apo_head"Placeholder="<?php echo $apo_head ?>" >
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Apo Paragraph</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="apo_para" placeholder="<?php echo $apo_para ?>">    
                            </div>
