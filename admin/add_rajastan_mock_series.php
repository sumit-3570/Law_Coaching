<?php
   ...
   if(isset($_POST['save'])) {
    $ins_prep_c="INSERT INTO rjs_mock_test SET
        	best='$RJS_mock_best',
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Add RJS Mock Test Series</span>
                    <h3 class="my-3 text-center"> Add RJS Mock Test Series </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS Mock Series best</label>
                                <input type="text" class="form-control my-1" id="exampleFormControlInput1" name="RJS_mock_best">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series title</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="RJS_mock_series_title">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series p1</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="RJS_mock_series_p1">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series p2</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="RJS_mock_series_p2">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series p3</label>
                                <input type="text" class="form-control my-1" id="exampleFormControlInput1" name="RJS_mock_series_p3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series Price</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="RJS_mock_series_Price">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series Discount</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="RJS_mock_series_discount">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series percent</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="RJS_mock_series_percent">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">RJS mock Series Color</label>
                                <input type="color" class="form-control my-1" required id="exampleFormControlInput1" name="RJS_mock_series_color">
