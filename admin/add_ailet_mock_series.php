<?php
   ...
   if(isset($_POST['save'])) {
    $ins_prep_c="INSERT INTO ailet_test_series SET
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Add Ailet Mock Test Series</span>
                    <h3 class="my-3 text-center"> Add Ailet Mock Test Series </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet Mock Series best</label>
                                <input type="text" class="form-control my-1" id="exampleFormControlInput1" name="ailet_mock_best">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series title</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="ailet_mock_series_title">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series p1</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_mock_series_p1">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series p2</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_mock_series_p2">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series p3</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_mock_series_p3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series Price</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="ailet_mock_series_Price">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series Discount</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="ailet_mock_series_discount">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series percent</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="ailet_mock_series_percent">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet mock Series Color</label>
                                <input type="color" class="form-control my-1" id="exampleFormControlInput1" name="ailet_mock_series_color">
