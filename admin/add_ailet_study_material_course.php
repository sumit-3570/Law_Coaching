<?php
   ...
   if(isset($_POST['save'])) {
    $ins_prep_c="INSERT INTO ailet_study SET
            ...
            <div class="col-9 clm_dash">
                    ...
                    <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_head">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet study material paragraph</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_para">
