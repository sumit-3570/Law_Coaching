            ...
            <div class="col-9 clm_dash">
                    ...
                    <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_head"placeholder="<?php echo $clat_study_material_head?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">clat study material paragraph</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_para"placeholder="<?php echo $clat_study_material_para ?>">
