<?php
   ...
   if(isset($_POST['save'])) {
    $ins_prep_c="INSERT INTO multi_state_material SET
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Add Multi-state Study material</span>
                    <h3 class="my-3 text-center"> Add Multi-state Study material </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi Study material image</label>
                                <input type="file" class="form-control my-1" id="exampleFormControlInput1" name="multi_study_material_image">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi Study Course title</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_course_tile">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi study material lines 1 </label>
                              
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_material_lines_1">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi study material lines 2 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_material_lines_2">
                              <label for="exampleFormControlInput1" class="form-label fw-bold">multi study material lines 3 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_material_lines_3">
                              <label for="exampleFormControlInput1" class="form-label fw-bold">multi study material lines 4 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_material_lines_4">
                               
                                
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi Study material Price</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_materia_Price">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi Study material Discount</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_materia_discount">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">multi Study  Discount percent</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="multi_study_materia_percentage">
