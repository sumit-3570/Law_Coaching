<?php
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE clat_study_course SET
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Edit Clat Study material</span>
                    <h3 class="my-3 text-center"> Edit Clat Study material </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Clat Study material image</label>
                                <input type="file" class="form-control my-1" id="exampleFormControlInput1" name="clat_study_material_image"placeholder="<?php echo $clat_study_material_image ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Clat Study Course title</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_course_tile"placeholder="<?php echo $clat_study_course_tile ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">clat study material lines 1 </label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_lines_1"placeholder="<?php echo $clat_study_material_lines_1 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">clat study material lines 2 </label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_lines_2"placeholder="<?php echo $clat_study_material_lines_2 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">clat study material lines 3 </label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_lines_3"placeholder="<?php echo $clat_study_material_lines_3 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">clat study material lines 4</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_material_lines_4"placeholder="<?php echo $clat_study_material_lines_4 ?>">

                               
                                
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Clat Study material Price</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="clat_study_materia_Price" placeholder="<?php echo $clat_study_materia_Price ?>">
