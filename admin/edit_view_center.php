            ...
            <div class="col-9 clm_dash">
                    ...
                    <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="Center_title"placeholder="<?php echo $Center_title?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Center Mobile</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="Center_mobile"placeholder="<?php echo $Center_mobile?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Center Email</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="Center_email"placeholder="<?php echo $Center_email ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Center Address</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="Center_address"placeholder="<?php echo $Center_address ?>">
