<?php
    ...
    $rajastan_course_link=$_POST['rajastan_course_link'];
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE rajastan_course SET
            ...
            WHERE 	rajastan_course_id ='$rajastan_id'   
            ...
            <div class="col-9 clm_dash">
                    ...
                    <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control my-1" id="exampleFormControlInput1" name="rajastan_course_live" placeholder="<?php echo $rajastan_course_live ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajastan Course title</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="rajastan_course_tile"placeholder="<?php echo $rajastan_course_tile ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajastan Course Link</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="rajastan_course_link"placeholder="<?php echo $rajastan_course_link ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajastan Course duration</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="rajastan_course_duration"placeholder="<?php echo $rajastan_course_duration ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajastan Course eligible</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="rajastan_course_eligible"placeholder="<?php echo $rajastan_course_eligible ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajastan Course Hour</label>
                                <input type="text" class="form-control my-1"id="exampleFormControlInput1" name="rajastan_course_hour"placeholder="<?php echo $rajastan_course_hour  ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Rajstan Course Price</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="rajastan_course_Price"placeholder="<?php echo $rajastan_course_Price  ?>">
