<?php
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE ailet_study_course SET
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Edit Ailet Study material</span>
                    <h3 class="my-3 text-center"> Edit Ailet Study material </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet Study material image</label>
                                <input type="file" class="form-control my-1" id="exampleFormControlInput1" name="ailet_study_material_image"<?php echo $ailet_study_material_image ?>>
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet Study Course title</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_course_tile"<?php echo $ailet_study_course_tile ?>>
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet study material lines 1 </label>
                              
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_lines_1"<?php echo $ailet_study_material_lines_1 ?>>
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet study material lines 2 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_lines_2"<?php echo $ailet_study_material_lines_2 ?>>
                              <label for="exampleFormControlInput1" class="form-label fw-bold">ailet study material lines 3 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_lines_3"<?php echo $ailet_study_material_lines_3 ?>>
                              <label for="exampleFormControlInput1" class="form-label fw-bold">ailet study material lines 4 </label>
                              
                              <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_material_lines_4"<?php echo $ailet_study_material_lines_4 ?>>
                               
                                
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet Study material Price</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_materia_Price"<?php echo $ailet_study_materia_Price ?>>
                                <label for="exampleFormControlInput1" class="form-label fw-bold">ailet Study material Discount</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_study_materia_discount"<?php echo $ailet_study_materia_discount ?>>
