...
if(isset($c_p_del)) {
    $del_clat_p="DELETE FROM legal_aspiration WHERE legal_aspiration_id ='$c_p_del'";
...
// multi delete start
    ...
    foreach ($clatdel as $key => $value) {
        if($_POST['submit']) {
           $delall_clat_p="DELETE FROM legal_aspiration WHERE legal_aspiration_id='$value'"; 
...
if(isset($id_stst)) {
    $up="UPDATE legal_aspiration SET
        legal_aspiration_status ='$status'
        WHERE legal_aspiration_id='$id_stst';
    ";
...
$sel_pagination = "SELECT * FROM legal_aspiration";
...
?>
      <div class="col-9 clm_dash">
                ...
                <h2 class="my-1 text-center"> View Legal Aspiration </h2>
                        ...
                        <table class="table">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <?php
                                       $sel_clat_p="SELECT * FROM legal_aspiration LIMIT $start,$Limit";
                            ...
                            <tbody>
                                 <tr>
                                    <td>
                                        <input type="checkbox" name="clatdel[]" value="<?php echo $fetch_clat_p['legal_aspiration_id'] ?>">
                                    </td>
                                    <td><?php echo $fetch_clat_p['legal_aspiration_id'] ?></td>
                                    <td><?php echo $fetch_clat_p['legal_aspiration_sub_head'] ?></td>
                                    <td><?php echo $fetch_clat_p['legal_aspiration_p'] ?></td>
                                    <td>
                                        <?php 
                                            if($fetch_clat_p['legal_aspiration_status']) {
                                        ?>
                                        <a href="view_legal_aspiration.php?id_stst=<?php echo $fetch_clat_p['legal_aspiration_id'] ?>&status=0">
                                        ...
                                        ?>
                                            <a href="view_legal_aspiration.php?id_stst=<?php echo $fetch_clat_p['legal_aspiration_id'] ?>&status=1">
                                    ...
                                    <td>
                                        <a href="edit_legal_aspiration.php?id_edit=<?php echo $fetch_clat_p['legal_aspiration_id'] ?>" >
                                            <button class="btn btn-success" type="button">Edit</button>
                                        </a>
                                        
                                        <a href="view_legal_aspiration.php?c_p_del=<?php echo $fetch_clat_p['legal_aspiration_id'] ?>">
