<?php
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE civil_mock_series SET
            ...
            WHERE civil_mock_series_id ='$edit_id';
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Edit CivilMock Test Series</span>
                    <h3 class="my-3 text-center"> Edit CivilMock Test Series </h3>
                    <form method="post">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series Selling</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="civil_mock_series_selling"placeholder="<?php echo $civil_mock_series_selling  ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series title</label>
                                <input type="text" class="form-control my-1"  id="exampleFormControlInput1" name="civil_mock_series_title"placeholder="<?php echo $civil_mock_series_title ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series p1</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="civil_mock_series_p1"placeholder="<?php echo $civil_mock_series_p1 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series p2</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="civil_mock_series_p2"placeholder="<?php echo $civil_mock_series_p2 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series p3</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="civil_mock_series_p3"placeholder="<?php echo $civil_mock_series_p3 ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series Price</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="civil_mock_series_Price"placeholder="<?php echo $civil_mock_series_Price ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series Discount</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="civil_mock_series_discount"placeholder="<?php echo  $civil_mock_series_discount?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series percent</label>
                                <input type="text" class="form-control my-1"  accept="" id="exampleFormControlInput1" name="civil_mock_series_percent"placeholder="<?php echo $civil_mock_series_percent ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">civil mock Series Color</label>
                                <input type="color" class="form-control my-1" required id="exampleFormControlInput1" name="civil_mock_series_color"placeholder="<?php echo $civil_mock_series_color  ?>">
