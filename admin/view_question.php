...
if(isset($c_p_del)) {
    $del_clat_p="DELETE FROM question WHERE question_id='$c_p_del'";
...
// multi delete start
    ...
    foreach ($clatdel as $key => $value) {
        if($_POST['submit']) {
           $delall_clat_p="DELETE FROM question WHERE question_id='$value'"; 
...
$sel_pagination = "SELECT * FROM question";
                        ...
                        <table class="table">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <?php
                                       $sel_clat_p="SELECT * FROM question LIMIT $start,$Limit";
                            ...
                            <tbody>
                                 <tr>
                                    <td>
                                        <input type="checkbox" name="clatdel[]" value="<?php echo $fetch_clat_p['question_id'] ?>">
                                    </td>
                                    <td><?php echo $fetch_clat_p['question_id'] ?></td>
                                    <td><?php echo $fetch_clat_p['question_heading'] ?></td>
                                    <td><?php echo $fetch_clat_p['question_para'] ?></td>
                                  
                                    <td>
                                        <a href="edit_question.php?ques_edit=<?php echo $fetch_clat_p['question_id'] ?>">
                                             <button class="btn btn-success" type="button">Edit</button>
                                         </a>
                                       
                                        <a href="view_question.php? c_p_del=<?php echo $fetch_clat_p['question_id'] ?>">
