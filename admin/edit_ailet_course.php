<?php
   ...
   if(isset($_POST['save'])) {
    $up_prep_c="UPDATE ailet_classes SET
...
?>
            <div class="col-9 clm_dash">
                    <span class="text-black"><a href="home.php">Home/</a>Edit Ailet courses</span>
                    <h3 class="my-3 text-center"> Edit Ailet courses </h3>
                    <form method="post">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Live</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_class_live" placeholder="<?php echo $ailet_class_live  ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Heading</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_class_head" placeholder="<?php echo $ailet_class_head  ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Duration</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_class_duration" placeholder="<?php echo $ailet_class_duration  ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Eligibility</label>
                                <input type="text" class="form-control my-1"id="exampleFormControlInput1" name="ailet_class_eligible"placeholder="<?php echo $ailet_class_eligible ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class hour</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_class_hour" placeholder="<?php echo $ailet_class_hour ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Price</label>
                                <input type="text" class="form-control my-1" required id="exampleFormControlInput1" name="ailet_class_Price" placeholder="<?php echo $ailet_class_Price ?>">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Ailet class Link</label>
                                <input type="text" class="form-control my-1" id="exampleFormControlInput1" name="ailet_class_link"placeholder="<?php echo $ailet_class_link?>">     
                            </div>
