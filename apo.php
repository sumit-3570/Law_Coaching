...
<div class="container-fluid section1_clat_main">
        <div class="container section1_clat_middle">
           <div class="row">
            <?php
              $sel_apo="SELECT * FROM apo_heading";
              $exe_apo=mysqli_query($conn,$sel_apo);
              $fetch_apo=mysqli_fetch_assoc($exe_apo);
            ?>
            <div class="col-12 text-center  pt-4">
                 <h1 class="clat_title mb-md-20 mb-12 "><?php echo $fetch_apo['apo_heading_title'] ?></h1>
                 <p class="p_title"><?php echo $fetch_apo['apo_heading_para'] ?></p>
            </div>
           </div>
...
<div class="container-fluid section2_clat_main">
    ...
    <h1 class="clat_title mb-md-20 mb-12 text-center text-lg-start "> RPSC APO Coaching Programs</h1>
        <div class="row section2_clat_rw row-cols-xxl-4 row-cols-lg-3 row-cols-2  justify-content-xl-between justify-content-center">
          <?php
              $sel_apo_c="SELECT * FROM apo_course WHERE apo_course_status='1'" ;
              $exe_apo_c=mysqli_query($conn,$sel_apo_c);
              $fetch_apo_c=mysqli_fetch_assoc($exe_apo_c);
          ...
          ?>
            <div class="col clm_section2_clat pt-4 pb-5 ">
                <div class="first_c d-flex justify-content-between ">
                    ...
                    <span class="live_label fs-11 fw-600  rounded-1  px-2 text-uppercase"><?php echo $fetch_apo_c['apo_course_live'] ?></span>
                </div>
                <div class="c_head">
                    <a href="<?php echo $fetch_apo_c['apo_course_link'] ?>">
                        <h3 class="clat_title mb-md-20 mb-12 my-3 " style="border:none;"><?php echo $fetch_apo_c['apo_title_course'] ?></h3>
                    </a>    
                        <ul class="list-unstyled">
                            <li style="background-color:#f6efef; width:218px" class="mb-2">Duration: <span style="font-weight:500;"><?php echo $fetch_apo_c['apo_course_duration'] ?></span>  </li>
                            <li style="background-color:#f6efef; width:218px" class="mb-2">Eligibility: <span style="font-weight:500;"><?php echo $fetch_apo_c['apo_course_eligible'] ?></span>  </li>
                            <li style="background-color:#f6efef; width:218px"><?php echo $fetch_apo_c['apo_course_hour'] ?> + <span style="font-weight:500;">Hours of Classes</span>  </li>
                        </ul>
...
<div class="container-fluid section5_main">
      <div class="container section5_middle">
          <h2 class="home_title text-center">Why Choose Law Prep Judiciary for RPSC APO Coaching?</h2>
          <p class="p_title text-center">Law Prep Judiciary is the best platform for APO online coaching</p>
          <div class="row section5_rw justify-content-around">
              <div class="col-lg-6 col-12 section5_clm">
                <div class="batch">
                  ...
                  <h3 class="common_heading">Highly Interactive Live ClassesE</h3>
                </div>
...
<!-- clat section3 best clat coaching end -->
 ...
 <div class="container-fluid section8_main">
      <div class="container section8_middle">
        <h2 class="home_title text-center mb-12 pt-5">FAQs About Rajasthan APO Coaching</h2>
